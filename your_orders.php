<html>
<head>
	<title>Food Lover: Your Orders</title>
...
<body>
	...
	<ul class="navbar">
		...
		<li class="dropdown list_items" >
			<a href="javascript:void(0)" class="dropbtn" >Your Orders</a>
			<div class="dropdown-content">
				<a href="your_profile.html">Your Profile</a>
				<a href="your_orders.html">Your Orders</a>
				<a href="your_wallet.html">Your Wallet</a>
